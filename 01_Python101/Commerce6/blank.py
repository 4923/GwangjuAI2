...
class Commerece6_purchase:
    ...
    def cart_look(self):
        ...
        cart_df = pd.read_csv(
            "./my_cart.csv", header=None, names=["Title", "Price"], usecols=[1, 2]
        )
        total_price = 0
...
class Commerce6_product:
            ...
            if choice_product_bookorder == 1:
                if Commerce6_product.secure():
                    choice_list = pd.Series(
                        ...
                        index=["nickname", "choice_book", "price"],
                    )
    ...
    def product_receipt(self):
        ...
        print("배송을 시작합니다. \n\n 배송정보\n")
        print(
            "{}님이 구매 신청하신 서적 {}이 {}로 3일내로 도착 예정입니다.".format(
