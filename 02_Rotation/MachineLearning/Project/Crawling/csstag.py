...
poet_list = soup.select("#mw-content-text > div.mw-parser-output > ul:nth-child(6) > li > b > a")
poet_list = soup.select("#mw-content-text > div.mw-parser-output > ul a")   # > 를 쓰면 그 밑에있는것을 지정, 없이 띄어쓰기 기준으로 나열하면 ul 밑에 있는 모든 a
